...
Reference revision: `a563e689a06d3b6226e63cadc0813b321e9cbd73` in the creator's `ghfjdksl1234/mac_mouse_helper` repository.

- [GrandCircleView.m](https://github.com/ghfjdksl1234/mac_mouse_helper/blob/a563e689a06d3b6226e63cadc0813b321e9cbd73/whereismymouse/GrandCircleView.m) uses `NSGradient` with `NSColor.red`, `NSColor.yellow`, `NSColor.red`. The colors are evenly spaced from the outer to the inner edge. Both the circle's interior and its surroundings remain transparent.
- Band width is `min(radius * 0.1, 60)` desktop points. Use the original `max(radius * 0.9, radius - 60)` inner-radius calculation.
- [ShakeDisplayManager.m](https://github.com/ghfjdksl1234/mac_mouse_helper/blob/a563e689a06d3b6226e63cadc0813b321e9cbd73/whereismymouse/ShakeDisplayManager.m) contracts the circle linearly over 1.5 seconds. Preserve full opacity during that sweep and let it finish before starting another.
