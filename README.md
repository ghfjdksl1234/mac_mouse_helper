...
A native macOS recreation of the original [Where is My Mouse?](https://macnews.tistory.com/4007) by Inbedsoft. A small menu-bar utility for finding your pointer, getting past blocked display edges, and physically lining up monitors.
...
- Individual feature switches, a pause control, launch at login, and persistent settings. Closing Settings leaves the menu-bar helper running; Quit exits it.
